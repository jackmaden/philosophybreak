...
<h4 class="blockquote fade-right">Rather than the fun-loving carbon-based lifeforms we believe ourselves to be, we are in fact the artificial simulations of future civilizations, existent only as silicon chips in their data warehouses.</h4>
...
<h4 class="blockquote fade-right">If future anthropologists had the ability to recreate certain periods of human history and play them out, for example, why wouldn’t they?</h4>
...
<p>Before we go crazy and riot in the streets in the name of fuck-it-all nihilism, however, let’s have a look at how we could possibly respond to Bostrom’s argument.</p>
...
<h4 class="blockquote fade-right">There are significant questions around whether or not technology could ever facilitate the necessary conditions for replicating human experience.</h4>
