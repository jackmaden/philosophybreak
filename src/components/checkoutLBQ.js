...
export class CheckoutLBQ extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        price: '$19' //default to show $29
    }
  }
  ...
  componentDidMount(){
    ...
    render () {
      return (
        <>
        <a className="button primary full-width top-icon-align" href="https://buy.stripe.com/4gMdR922x9llc3VbGO8og0k">
        ...
        <Link className="button secondary full-width top-icon-align" to="/lifes-big-questions/gift-purchase/">
