        ...
        <div className={props.class + " course large-pad coursepanel"}>
            <Link to="/how-to-live-a-good-life/">
                <div className={props.flexdirection + " two-col big-1-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <h3 className="pfl smaller">How to Live a Good Life (According to 7 of the World’s Wisest Philosophies)</h3>
                        ...
                        <p className="large-grey-font no-mar-top-mob">Discover and compare the wisdom of Stoicism, Existentialism, Buddhism and beyond to forever enrich your personal philosophy.</p>


                        <button className="button primary full-width"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M504 256C504 119 393 8 256 8S8 119 8 256s111 248 248 248 248-111 248-248zm-448 0c0-110.5 89.5-200 200-200s200 89.5 200 200-89.5 200-200 200S56 366.5 56 256zm72 20v-40c0-6.6 5.4-12 12-12h116v-67c0-10.7 12.9-16 20.5-8.5l99 99c4.7 4.7 4.7 12.3 0 17l-99 99c-7.6 7.6-20.5 2.2-20.5-8.5v-67H140c-6.6 0-12-5.4-12-12z"/></svg>Explore Our Popular New Guide</button>
            ...
            <div className="small-pad no-pad-top-desktop">
                <div className="page-center text-center">
                    ...
                    <ReviewsLatestPFL />
                    <p className="no-mar-bottom"><Link to="/how-to-live-a-good-life/" className="white-underline" style={{fontSize: "16px"}}>See All Course Reviews</Link></p>
                </div>
            </div>   
