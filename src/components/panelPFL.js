            ...
            <Link to="/how-to-live-a-good-life/">
                <div className={props.flexdirection + " two-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <p className="large-grey-font no-mar-top-mob">Quickly compare the profound wisdom of Stoicism, Existentialism, Buddhism and beyond to see if they might enrich your own way of life. Access our popular new guide:</p>
