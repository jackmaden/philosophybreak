            ...
            <a href="/how-to-live-a-good-life/">
                <div className={props.flexdirection + " two-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <h3 className="pfl">How to Live a Good Life (According to 7 of the World’s Wisest Philosophies)</h3>
                        ...
                        <p className="large-grey-font no-mar-top-mob">Quickly compare the wisdom of Stoicism, Existentialism, Buddhism and beyond to forever enrich your personal philosophy. Explore our popular new guide now:</p>
