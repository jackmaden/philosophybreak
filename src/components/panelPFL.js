        ...
        <div className={props.class + " mid-pad coursepanel"}>
            <div className="page-center text-center">
                <div className="mid-width small-pad-bottom">
                    ...
                    <h3>How to Live a Good Life (According to 7 of the World’s Wisest Philosophies)</h3>
                    <p className="spectral">Enhance your approach to life by exploring 7 of the world’s wisest and most influential philosophies for living — including Stoicism, Existentialism, Buddhism, and beyond. Register your interest now:</p> 
                    <CoursePromoForm />
                </div>
            </div>
        </div>     
