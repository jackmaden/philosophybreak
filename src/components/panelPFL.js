            ...
            <Link to="/how-to-live-a-good-life/">
                <div className={props.flexdirection + " two-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <p className="large-grey-font no-mar-top-mob">Enhance your approach to life by exploring 7 of the world’s wisest and most influential philosophies for living — including Stoicism, Existentialism, Buddhism, and beyond.</p>
