            ...
            <Link to="/how-to-live-a-good-life/">
                <div className={props.flexdirection + " two-col big-1-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <p className="large-grey-font no-mar-top-mob">Quickly compare the wisdom of Stoicism, Existentialism, Buddhism and beyond to forever enrich your personal philosophy.</p>
