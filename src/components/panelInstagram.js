...
export default () => (
  <StaticQuery
    query={graphql`
      query {
        file(relativePath: {eq: "instagram.jpg"}) {
            childImageSharp {
                fluid(maxWidth: 2100) {
    ...
    render={data => (
        <div className="panel">
            <Img className="title-img" fluid={data.file.childImageSharp.fluid} alt="using phone" />
            <div className="darkener instagram-filter"></div>
            <div className="page-center">
                <h2>Enrich Your Instagram</h2>
                <div className="separator"></div>
                <p>It's easy to enter zombie mode on Instagram. Philosophy Break is a clearing in your cluttered newsfeed, steering you from consumption to thoughtfulness.</p>
