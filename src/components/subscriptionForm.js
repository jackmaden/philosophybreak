            ...
            <div className="grey-background">
                <div className="page-center text-center">
                    ...
                    <div id="mc_embed_signup">
                        ...
                        <p className="small-grey-font text-center">Treat yourself to philosophy breaks direct to your inbox, with weekly emails designed to make you think. Unsubscribe any time.</p>
                    </div>
                </div>
            </div>
        )
