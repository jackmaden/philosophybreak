...
const ReviewsLatestLBQ = () => (
    <div className="three-col align-top">
        ...
        <div className="small-mar">
            ...
            <span style={{lineHeight: "1.3"}}>Wonderful! So clear and inviting to use. Just the right level of challenge. Felt like I was really learning. My favorite chapter was the one on Consciousness - what is it? I wonder about this all the time. Thank you for doing this, Jack. Your work is such a gift.</span>
