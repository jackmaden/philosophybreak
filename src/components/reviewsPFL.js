...
const ReviewsPFL = () => (
    <div className="three-col align-top">
        ...
        <div className="small-mar">
            ...
            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Linda S. on 12 August 2026</span></div>
        </div>
        ...
        <div className="small-mar">
            ...
            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Jim M. on 28 July 2026</span></div>
        </div>
        ...
        <div className="small-mar">
            ...
            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Lee J. on 18 July 2026</span></div>
        </div>        
