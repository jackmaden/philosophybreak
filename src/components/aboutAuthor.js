...
const AboutAuthor = () => (   
    <div className="grey-background large-pad-top">
        ...
        <div className="two-col big-1-col about-author">
            ...
            <div>
            <p className="small-grey-font">👋 My name’s Jack, and I’m the Founder and Director of Philosophy Break. I’m the author of <Link to="/the-philosophy-prescription/">The Philosophy Prescription: Lessons from Big Thinkers for Every Stage of Life</Link> (Penguin Random House, 2026). <Link to="/about/">Learn more about me and Philosophy Break here.</Link></p>
