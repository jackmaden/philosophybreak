        ...
        <div id="footer">
            <div className="page-center">
                ...
                <div className="disclaimer-footer mid-width">
                    <p>Philosophy Break is an online social enterprise dedicated to making the wisdom of philosophy accessible, engaging, and useful for all. Learn more <Link to="/about/">about us here</Link>. To offset a fraction of what it costs to maintain Philosophy Break, we participate in the Amazon Associates Program. This means if you purchase something on Amazon from a link on here, we may earn a small percentage of the sale, at no extra cost to you. This helps support Philosophy Break, and is very much appreciated.</p> 
