    ...
    <div id="footer">
        <div className="page-center">
            ...
            <div className="disclaimer-footer">
                <p>Philosophy Break is a clearing in your cluttered newsfeed. Each break takes only a few minutes to read, and is designed to spark curiosity about a particular talking point in philosophy — from how best we can live our lives, to the ultimate nature of the worlds we live in. Learn more about us <Link to="/about">here</Link>.</p> 
