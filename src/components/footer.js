            ...
            <div className="page-center">
                <div className="logo-footer">
                    <Link to="/">
                        ...
                        <h3>Philosophy Break<small>Dedicated to popularizing philosophy</small></h3>
                    </Link>
                </div>
                ...
                <div className="disclaimer-footer mid-width">
                    <p>Philosophy Break is a social enterprise dedicated to getting more people engaged with philosophy. Learn more <Link to="/about/">about us</Link>. To offset a fraction of what it costs to maintain Philosophy Break and keep it ad-free, we participate in the Amazon Associates Program. This means if you purchase a book on Amazon from a link on here, we may earn a small percentage of its price, at no extra cost to you. This helps support Philosophy Break, and is very much appreciated.</p>
