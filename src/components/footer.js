    ...
    <div id="footer">
        <div className="page-center">
            ...
            <div className="disclaimer-footer">
                <p>Philosophy Break participates in the Amazon Associates Program. This means that whenever you buy a book on Amazon from a link on here, Philosophy Break earns a small percentage of its price, at no extra cost to you. This helps support Philosophy Break by offsetting a fraction of what it takes to maintain the site, and is very much appreciated.</p>
