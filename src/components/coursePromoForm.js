...
export class CoursePromoForm extends React.Component {
    ...
    render () {
        return (
            <>
                <form className="small-mar-top" style={{marginBottom: "0em"}} action="https://philosophybreak.us19.list-manage.com/subscribe/post?u=6f4dbbebde3dd2a464df28ec3&amp;id=cafc1bb7f6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank">
