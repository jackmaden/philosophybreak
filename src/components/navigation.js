            ...
            <div>
                <div id="nav" className={this.state.class + ' ' + this.props.bg + ' ' + this.state.fontColor}>
                    <div className="page-center">
                        ...
                        <h3 className={this.state.class}>Philosophy Break<span className={this.state.class}>Dedicated to popularizing philosophy</span></h3>
                        </Link>
                    ...
                    <div className="page-center">
                        <li className="primary one">{/*<!--get started-->*/}
                            <Link to="/what-is-philosophy-why-is-it-important-today/">
                                ...
                                <p className="small-grey-font">Your quick guide to how philosophy can improve your life and mind.</p>
                            </Link>
                        </li>
                        <li className="primary two">{/*<!--take a break-->*/}
                            <Link to="/articles/">
                                ...
                                <p className="small-grey-font">Bite-size articles designed to spark your philosophical curiosity.</p>
                            </Link>
                        </li>
