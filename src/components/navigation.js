                ...
                <div id="menu" className={(this.state.isClosed) ? '' : 'show'}>
                    <div className="page-center">
                        ...
                        <div className="li">{/*<!--sign in-->*/}
                            <a target="_blank" aria-label="Sign In" rel="noopener noreferrer" href="https://academy.philosophybreak.com/">
                                <div>
                        ...
                        <div className="li">{/*<!--instagram-->*/}
                            <a target="_blank" aria-label="Instagram" rel="noopener noreferrer" href="https://www.instagram.com/philosophybreak/">
                                <div>
