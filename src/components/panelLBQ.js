        ...
        <div className={props.class + " mid-pad"} id="first-panel">
            <div className="two-col big-1-col page-center">
                <div className="mobile-center">
                    ...
                    <p style={{marginBottom: 0}}><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <Link to="/lifes-big-questions/" className="white-underline" style={{fontSize: "16px"}}>(25 reviews)</Link></p>
                    <p className="verified discount">15% DISCOUNT – LIMITED OFFER</p>
                    <GatsbyImage
