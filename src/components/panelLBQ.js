        ...
        <div className={props.class + " mid-pad"} id="first-panel">
            <div className="two-col big-1-col row-reverse page-center">
                <div className="mobile-center">
                    ...
                    <p style={{marginBottom: 0}}><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <Link to="/lifes-big-questions/" className="white-underline" style={{fontSize: "16px"}}>(23 reviews)</Link></p>
                    <GatsbyImage
                    ...
                    <p className="large-grey-font">Why does anything exist? Do we have free will? How should we approach life? We’ve distilled the great philosopher’s best answers to life’s big questions. Start learning today.</p>
