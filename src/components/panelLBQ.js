          ...
          <Link to="/lifes-big-questions/">
            <div className={props.flexdirection + " two-col big-1-col page-center"}>
                <div className="mobile-center">
                    ...
                    <h2>Your Concise Shortcut to Philosophy’s Most Important Wisdom</h2>
                    ...
                    <p><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <Link to="/lifes-big-questions/" className="white-underline" style={{fontSize: "16px"}}>(36 reviews)</Link></p>
