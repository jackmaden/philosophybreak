        ...
        <div className="mid-pad darkradial-background" id="first-panel">
            <div className="two-col big-1-col row-reverse page-center">
                <div className="mobile-center">
                    ...
                    <p className="large-grey-font">Why does anything exist? Do we have free will? How should we approach life? Our celebrated introduction to philosophy summarizes the subject's best answers to life's big questions, taking you on a whirlwind journey of discovery.</p>
