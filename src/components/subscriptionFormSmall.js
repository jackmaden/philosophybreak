            ...
            <div className="darkradial-background large-pad">
                <div className="page-center text-center mid-width">
                    ...
                    <div id="mc_embed_signup">
                        ...
                        <p className="tiny-mar-top"><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <span style={{fontSize: "14px"}}>(50+ reviews for <Link to="/courses/">our courses</Link>). Unsubscribe any time.</span></p>
                    </div>
                </div>
            </div>
        )
