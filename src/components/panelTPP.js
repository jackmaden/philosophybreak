            ...
            <Link to="/the-philosophy-prescription/">
                <div className={props.flexdirection + " two-col massive-2-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <h2>Explore the new book from the founder of Philosophy Break</h2>
                        ...
                        <p>WINTER 2026 | Penguin Random House</p>

                        <p className="large-grey-font no-mar-top-mob">A warm, accessible guide to philosophy's best ideas: <i>The Philosophy Prescription</i> matches key ideas from ancient and modern thinkers to 16 common life stages.</p>
