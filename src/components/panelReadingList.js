...
export default function PanelReadingList() {
  const data = useStaticQuery(graphql`
    query {
      introduction: file(relativePath: {eq: "rl1.jpg"}) {
        childImageSharp {
          gatsbyImageData(width: 480, layout: CONSTRAINED)
        }
      }
      existentialism: file(relativePath: {eq: "rl5.jpg"}) {
        childImageSharp {
          gatsbyImageData(width: 480, layout: CONSTRAINED)
        }
      }
      ...
      stoicism: file(relativePath: {eq: "rl2.jpg"}) {
        childImageSharp {
          gatsbyImageData(width: 480, layout: CONSTRAINED)
        }
      }
  ...
  return (
    <div className="grey-background large-pad">
      <div className="page-center">
          ...
          <BannerReadingList title="An Introduction to Philosophy" number="6" link="/reading-lists/introduction-to-philosophy/" img={data.introduction.childImageSharp.gatsbyImageData} alt="Book, Pipe and Glasses, by Juan Gris" />
