    ...
    render={data => (
        <div className="panel">
            ...
            <div className="page-center">
                ...
                <p>Ready to deepen your knowledge? We've compiled reading lists of the most essential, compelling, and accessible works of particular philosophers and philosophical subjects.</p>
