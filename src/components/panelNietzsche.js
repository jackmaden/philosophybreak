            ...
            <Link to="/introduction-to-nietzsche/">
                <div className={props.flexdirection + " two-col big-1-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <Link className="heading-link" to="/introduction-to-nietzsche/"><h3>Your Myth-Busting Guide to Nietzsche & His 5 Greatest Ideas</h3></Link>
                        ...
                        <p><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <Link to="/introduction-to-nietzsche/" className="white-underline" style={{fontSize: "16px"}}>(12 reviews)</Link></p>
