            ...
            <Link to="/introduction-to-nietzsche/">
                <div className={props.flexdirection + " two-col big-1-col page-center"}>
                    ...
                    <div className="mobile-center">
                        ...
                        <Link className="heading-link" to="/introduction-to-nietzsche/"><h2>Your Myth-Busting Guide to Nietzsche & His 5 Greatest Ideas</h2></Link>
                        ...
                        <p className="large-grey-font no-mar-top-mob">Learn everything you need to know about Nietzsche in just six 30-minute daily chapters. This course distills his best and most misunderstood ideas, from God is dead to the Übermensch.</p>

                        <p><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <Link to="/introduction-to-nietzsche/" className="white-underline" style={{fontSize: "16px"}}>(11 reviews)</Link></p>

                        <Link className="button primary full-width" to="/introduction-to-nietzsche/"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M624 416H381.54c-.74 19.81-14.71 32-32.74 32H288c-18.69 0-33.02-17.47-32.77-32H16c-8.8 0-16 7.2-16 16v16c0 35.2 28.8 64 64 64h512c35.2 0 64-28.8 64-64v-16c0-8.8-7.2-16-16-16zM576 48c0-26.4-21.6-48-48-48H112C85.6 0 64 21.6 64 48v336h512V48zm-64 272H128V64h384v256z"></path></svg>Start Learning Now</Link>
                    </div>
                    <div className="mobile-no-display">
                        <GatsbyImage
                            image={data.lbq.childImageSharp.gatsbyImageData}
