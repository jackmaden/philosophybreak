...
const Page = () => {
    return (
        <>
        <Helmet title="Purchase as a Gift: Life’s Big Questions | Philosophy Break">
            ...
            <div className="darkradial-background small-pad-bottom">
                <div className="top-title text-center">
                    <div className="page-center">
                        <p className="small-grey-font mid-mar-bottom"><Link to="/lifes-big-questions/">← Back to course page</Link></p>
                        <h3 className="mid-width">Know someone who would love <i>Life’s Big Questions</i>? Present it to them as a gift in 4 easy steps:</h3>
                        ...
                        <p className="small-grey-font mid-width"><b>1.</b> <a href="https://buy.stripe.com/28oaFn6lagdH6bu5kz">Purchase a gift voucher</a> for the course using your email address</p>
                        ...
                        <a className="button primary full-width top-icon-align" href="https://buy.stripe.com/28oaFn6lagdH6bu5kz">
