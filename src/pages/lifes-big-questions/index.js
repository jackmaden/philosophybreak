        ...
        <div className="top-title darkradial-background course" id="top">
            <div className="two-col page-center">
                <div>
                    ...
                    <p className="spectral">Unlock instant access to 42 concise, self-paced lessons on the great philosophers’ best answers to life’s big questions. Join 800+ members inside:</p>
