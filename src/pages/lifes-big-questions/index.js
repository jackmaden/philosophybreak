...
const Page = ({ data, location }) => {
    ...
    <NavigationSimple/>
        ...
        <div className="top-title darkradial-background" id="top">
            <div className="two-col page-center">
                <div>
                    ...
                    <p style={{marginBottom: 0}}><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <AnchorLink href="#reviews" className="white-underline" style={{fontSize: "16px"}}>(25 reviews)</AnchorLink></p>
        ...
        {/*Reviews*/}
        <Reviews bg="darkradial-background" title="25 Course Reviews" toggle="primary" />
