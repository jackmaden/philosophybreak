...
const Page = ({ data, location }) => {
    ...
    <NavigationSimple/>
        ...
        <div className="top-title darkradial-background" id="top">
            <div className="two-col page-center">
                <div>
                    ...
                    <p style={{marginBottom: 0}}><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span> <AnchorLink href="#reviews" className="white-underline" style={{fontSize: "16px"}}>(29 reviews)</AnchorLink></p>
        ...
        {/*Reviews*/}
        <Reviews bg="darkradial-background" title="29 Course Reviews" toggle="primary" />
                ...
                <div id="faq">
                    ...
                    <div className="two-col align-top small-mar">
                        ...
                        <div>
                            ...
                            <p className="small-grey-font">The course is delivered over five days, with a new question considered each day. Each day's materials take about 20-30 minutes to read through, with an extra ten minutes or so recommended for reflection. You have access to course materials forever, so don't worry if you miss a day — you can take the course at your own pace.</p>
                        </div>
                    </div>
