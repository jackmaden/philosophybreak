...
const Page = ({ data, location }) => {
    ...
    <Navigation />
        ...
        <div className="page-center" id="break-start">
            ...
            <p>But beyond the study of such fundamental questions, philosophy can be defined more broadly as an <i>act</i>.</p> 
