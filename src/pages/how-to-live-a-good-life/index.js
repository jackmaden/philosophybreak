        ...
        <div className="top-title darkradial-background course" id="top">
            <div className="two-col page-center">
                <div>
                    ...
                    <p className="small-grey-font smaller text-center no-mar-top-mob desktop-no-display" style={{marginTop: "-12px"}}><i>The course is hosted on our new online learning platform, Philosophy Break Academy (accessible from any device).</i></p>
                ...
                <div className="mobile-no-display">
                    ...
                    <p className="small-grey-font smaller text-center no-mar-top-mob" style={{marginTop: "-12px"}}><i>The course is hosted on our new online learning platform, Philosophy Break Academy (accessible from any device).</i></p>
                </div>
            </div>
        </div>
