        ...
        <div className="top-title darkradial-background course" id="top">
            <div className="two-col page-center">
                <div>
                    ...
                    <p className="spectral">Unlock instant access to 56 concise, self-paced lessons on Stoicism, Existentialism, Buddhism and beyond. Join 500+ members inside:</p>
                ...
                <div className="page-center">
                    ...
                    <div className="two-col wrap align-top">
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Tony D. on 21 August 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Rajeev S. on 22 July 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Ian H. on 31 January 2025</span></div>
                        </div>

                        <div className="small-mar">
                            <p style={{marginBottom: "0.5em"}}><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span>&nbsp;&nbsp;<span><i>Excellent</i></span></p>
                            <span style={{lineHeight: "1.3"}}>This course experience was awesome! I gained game changing insights which were profound and very helpful. I understand myself and the world I live in much better now! Easy to navigate. Displayed well. Sharing comments was easy. I had two favorite chapters...Stoicism and Existentialism. I think these chapters address the vagaries of life and the human condition in the most practical and meaningful way. These philosophical constructs were real eye openers for me. Excellent work!</span>
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Christopher R. on 21 December 2024</span></div>
                        </div>
                        
                        <div className="small-mar">
                            <p style={{marginBottom: "0.5em"}}><span style={{color: "#ffc536"}}>&#9733;&#9733;&#9733;&#9733;&#9733;</span>&nbsp;&nbsp;<span><i>Really enjoyed</i></span></p>
                            <span style={{lineHeight: "1.3"}}>Really enjoyed the course and have followed up with some of the recommended books. I found the overlap between different philosophies really interesting despite coming from different cultures and times eg Buddhism, Stoicism and existentialism.</span>
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Barry K. on 11 December 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Linda S. on 22 August 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Jim M. on 28 July 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Lee J. on 18 July 2024</span></div>
                        </div>
