                ...
                <div className="page-center">
                    ...
                    <div className="two-col wrap align-top">
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Tony D. on 12 August 2026</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Rajeev S. on 22 July 2026</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Ian H. on 31 January 2026</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Christopher R. on 21 December 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Barry K. on 11 December 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Linda S. on 22 August 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Jim M. on 28 July 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Lee J. on 18 July 2025</span></div>
                        </div>
