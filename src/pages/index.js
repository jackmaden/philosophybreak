...
export default ({ data }) => {
    ...
    return (
        <>
        <SEO title="Philosophy Break – A Clearing in Your Cluttered Newsfeed" description="The home for thought-provoking philosophy content – from Socrates, Plato, and Aristotle; to Kant, Kierkegaard, and Nietzsche."/>
        <Layout>
            ...
            <div className="darkener"></div>
                <div className="page-center">
                    <animated.div style={dropIn}>
                        ...
                        <p>Break up the noise of everyday life with new and enduring ideas from philosophy, and start making your days more thoughtful and fulfilling.</p>
                    </animated.div>
