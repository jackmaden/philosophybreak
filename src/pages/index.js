        ...
        <div className="darkradial-background top-title home">
          <div className="two-col big-2-col page-center">
            <div className="mobile-center">
              ...
              <p className="small-grey-font" style={{marginBottom: 0}}>From the Buddha to Nietzsche: join 24,000+ subscribers enjoying a nugget of profundity from the great philosophers every Sunday:</p>
              <WelcomeEmailForm />
