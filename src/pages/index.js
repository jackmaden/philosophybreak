            ...
            <div className="darkener"></div>
                <div className="page-center">
                    <animated.div style={dropIn}>
                        ...
                        <p>Welcome to a clearing in your cluttered newsfeed. Here you can break through life's noise and expand your mind with philosophy's best questions, quotes, and ideas.</p>
                    </animated.div>
