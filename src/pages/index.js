...
export default ({ data }) => {
    ...
    return (
        ...
        <Layout>
            ...
            <div className="darkener"></div>
                <div className="page-center">
                    <animated.div style={dropIn}>
                        ...
                        <p>Welcome to a clearing in your cluttered newsfeed — a place to expand your mind with philosophy's best questions, quotes, and ideas.</p>
                    </animated.div>
            ...
            <div id="first-panel" className="grey-background" style={{paddingTop: "48px"}}>
                <HomeArticleList />
            </div>
            <SubscriptionForm />
            <PanelInstagram />
