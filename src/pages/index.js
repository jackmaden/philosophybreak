...
export default ({ data }) => {
    ...
    <Navigation />
        ...
        <GatsbyImage image={pic} fadeIn={false} loading="eager" alt="Philosophy Break" />
...
export const query = graphql`{
  default: file(relativePath: {eq: "philosophy-break.jpg"}) {
    childImageSharp {
      gatsbyImageData(height: 1000, quality: 80, layout: FULL_WIDTH)
    }
  }
  morning: file(relativePath: {eq: "morning.jpg"}) {
    childImageSharp {
      gatsbyImageData(height: 1000, quality: 90, layout: FULL_WIDTH)
    }
  }
