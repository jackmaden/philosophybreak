        ...
        <Navigation bg="light-bg" />
            ...
            <div className="top-title text-center">
                <div className="page-center">
                    ...
                    <p className="mid-width large-grey-font">Welcome to Philosophy Break, a place to promptly enrich your mind with philosophy's best questions, quotes, and ideas.</p>
                </div>
            </div>
            <div className="mid-mar mid-pad-bottom">
                <div className="two-col big-2-col row-reverse page-center">
                    ...
                    <div className="mobile-center">
                        ...
                        <p className="large-grey-font">Our celebrated introductory philosophy course distills philosophy's best answers to some of life's most troubling questions, taking you on a whirlwind five-day journey of reflection, understanding, and discovery.</p>
...
export const query = graphql`
    query {
        lbq: file(relativePath: {eq: "LBQ-square.png"}) {
            childImageSharp {
