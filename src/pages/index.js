        ...
        <div className="darkradial-background top-title home">
          <div className="two-col big-2-col page-center">
            <div className="mobile-center">
              ...
              <p className="large-grey-font home">Quickly enrich your personal philosophy by comparing the wisdom of Stoicism, Existentialism, Buddhism and beyond. Explore our popular new guide now:</p>
