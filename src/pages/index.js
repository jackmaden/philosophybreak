...
export default ({ data }) => {
    ...
    return (
        <>
        <SEO title="Philosophy Break – A Clearing in Your Cluttered Newsfeed" description="Thought-provoking articles on philosophy, designed to expand your mind and spark your curiosity."/>
        <Layout>
            ...
            <div className="darkener"></div>
                <div className="page-center">
                    <animated.div style={dropIn}>
                        ...
                        <p>Kick back and expand your mind with short, informative philosophy breaks designed to make you think.</p>
                    </animated.div>
