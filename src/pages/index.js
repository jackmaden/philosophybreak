...
const Page = ({ data }) => {
    ...
    <Navigation />
        ...
        <GatsbyImage image={pic} alt="Philosophy Break" />
        <div className="darkener"></div>
            <div className="page-center text-center">
                <div>
                    <h1 id="home-page">{greet}</h1>
                    <div className="separator"></div>
                    <p className="mid-width">Welcome to Philosophy Break, a place to enrich your mind with philosophy's best questions, wisdom, and ideas.</p>
                </div>
                <div>
