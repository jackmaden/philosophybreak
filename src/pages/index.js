            ...
            <div className="darkener"></div>
                <div className="page-center text-center">
                    <animated.div style={dropIn}>
                        ...
                        <p className="mid-width">Welcome to Philosophy Break, a place to enrich your mind with philosophy's best questions, quotes, and ideas.</p>
                    </animated.div>
...
export const query = graphql`
    query {
        default: file(relativePath: {eq: "philosophy-break.jpg"}) {
            childImageSharp {
                fluid(maxHeight: 1000, quality: 80) {
