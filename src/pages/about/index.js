        ...
        <Layout>
            ...
            <WindowHeightWrapper className="title">
                ...
                <animated.div style={dropIn} className="page-center title-center">
                    ...
                    <p className="description">Philosophy Break is a clearing in your cluttered newsfeed. It's home to content designed to expand your mind and spark your philosophical curiosity — from how best we can live our lives, to the ultimate nature of the worlds we live in.</p>
                </animated.div>
            ...
            <div id="break-start" className="page-center" style={{marginBottom: 48}}>
                <p><span className="big-letter">P</span>hilosophy Break was created in 2018 by <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/jack-maden/">Jack Maden</a> with a simple mission: to get more people engaged with philosophy. Why? Because we believe philosophy is the antidote to a world saturated by information — and that the more people engage with it, the more fulfilling their lives will be.</p>
                <p>Philosophy as a subject has much to offer; but it is philosophy as an <i>act</i> that we seek to popularize. <i>To philosophize</i> means asking 'why', it means challenging assumptions, it means harnessing your curiosity to forge your own path. We believe it is only by living philosophically that each of us can cultivate a meaningful existence and fully realize our human potential. For as Socrates, <Link to="/articles/socrates-on-what-we-know">that great martyr of philosophy</Link>, declared:</p>
                <blockquote><p>"The unexamined life is not worth living."</p></blockquote>
                <p>For regular clearings in your cluttered newsfeed, designed to disrupt the noise and keep your mind curious, make sure you <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/philosophybreak/">follow Philosophy Break on Instagram</a> and subscribe to our newsletter below.</p>
                <p>Like our cause? Help us spread the word by sharing Philosophy Break with your friends and family on your network of choice — providing a clearing in those cluttered newsfeeds too.</p>
            </div>
