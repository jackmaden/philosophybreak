        ...
        <div className="two-col mid-pad big-2-col page-center">
            <div>
                ...
                <div className="spectral">
                  <p><span className="big-letter">W</span>e believe philosophy is the antidote to a world saturated by information. While there is no guidebook for life, philosophers have had incredibly insightful things to say about existence for thousands of years. We want to shine a light on those nuggets of wisdom, because we think they can help unlock immense clarity for people striving to live meaningful and fulfilling lives. You can learn more about our views on the power of philosophy in our free, <Link to="/philosophy-basics/">3-lesson email course on what philosopy is and how it can improve your life</Link>.</p>
