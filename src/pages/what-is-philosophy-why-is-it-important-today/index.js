...
export default ({ data, location }) => {
    ...
    <Navigation />
        ...
        <div className="page-center" id="break-start">
            ...
            <p>(If you’re interested in facing up to these questions right away, check out our <Link to="/lifes-big-questions/">celebrated introductory philosophy course: Life’s Big Questions</Link>, which distills philosophy’s best answers from the last few millennia.)</p>
...
export const query = graphql`{
  space: file(relativePath: {eq: "space.jpg"}) {
    childImageSharp {
      gatsbyImageData(height: 1000, layout: FULL_WIDTH)
    }
  }
}
`