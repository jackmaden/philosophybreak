    ...
    return (
        ...
        <Navigation bg="light-bg" />
            ...
            <div className="grey-background">
                ...
                {/*page title*/}
                <TopTitle class='' title="Take a Break" subtitle="Each break takes only a few minutes to read, and is crafted to expand your mind and spark your philosophical curiosity." />
                        ...
                        {edges.map(edge => {
                            ...
                            return (
                                <div className="article" key={frontmatter.date}>
                                    <Link to={fields.slug}>
                                        <Img fluid={frontmatter.image.childImageSharp.fluid} loading="eager" alt={frontmatter.imageAlt} />
