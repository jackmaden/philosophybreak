...
Stoic cosmopolitanism operates on the belief — the hope — that a grand collective of such vines will build a better world.
...
Rather, I mean a kind of background, context-independent _faith_ that motivates and justifies good action. A faith that says: a better life for ourselves and others can emerge only if we each decide to help build one, so we should release our attachment to wider circumstances, and focus on finding joy (_chara_) in our own efforts. A faith that says: good action is its own reward. A Stoic, cosmopolitan faith that says: the ultimate result, in our quest for the good life, is knowing we’ve done our best.
