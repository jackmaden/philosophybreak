        ...
        <div className="top-title darkradial-background course" id="top">
            <div className="two-col page-center">
                ...
                <span className="tag time"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="#fff" d="M624 416H381.54c-.74 19.81-14.71 32-32.74 32H288c-18.69 0-33.02-17.47-32.77-32H16c-8.8 0-16 7.2-16 16v16c0 35.2 28.8 64 64 64h512c35.2 0 64-28.8 64-64v-16c0-8.8-7.2-16-16-16zM576 48c0-26.4-21.6-48-48-48H112C85.6 0 64 21.6 64 48v336h512V48zm-64 272H128V64h384v256z"/></svg>COURSE & COMMUNITY</span><div className="separator course pfl"></div>
                    ...
                    <p className="spectral">Unlock instant access to 42 concise, self-paced lessons on Nietzsche’s fascinating yet much-misunderstood philosophy. Join 800+ members inside:</p>
                ...
                <div className="page-center">
                    ...
                    <div className="two-col wrap align-top">
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Deborah W. on 17 April 2026</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Sabine V. on 18 December 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Robert N. on 10 August 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Stacey L. on 15 June 2025</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Elsa V. on 6 December 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Milad A. on 24 November 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Robert J. on 19 July 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Julien S. on 22 March 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Joaquim N. on 16 March 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>David U. on 11 March 2024</span></div>
                        </div>
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Brian P. on 27 February 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Chuck M. on 25 February 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Marie L. on 19 February 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Andy G. on 18 February 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Lesh W. on 13 February 2024</span></div>
                        </div>
                        ...
                        <div className="small-mar">
                            ...
                            <div><p className="verified">VERIFIED BUYER</p>&nbsp;&nbsp;<span style={{color: "#737d88"}}>Sophie D. on 11 February 2024</span></div>
                        </div>
                    </div>
                </div>
            </div>
