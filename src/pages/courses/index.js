...
const Page = ({ location }) => {
    ...
    <div className="grey-background">
        ...
        {/*page title*/}
        <TopTitle class="no-mar-bottom" title="Philosophy Courses" subtitle="Explore our quick, introductory philosophy courses, where you can learn the subject’s greatest wisdom in days rather than years." />            
        </div>
