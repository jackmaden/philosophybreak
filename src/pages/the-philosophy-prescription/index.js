...
const Page = ({ data, location }) => {
    ...
    <NavigationSimple bg="light-bg" />
         ...
         <div id="top" className="top-title grey-background home">
          <div className="two-col massive-1-col page-center" style={{alignItems: "top"}}>
            <div>
              <GatsbyImage
            ...
            <div className="book-orders">
              ...
              <p className="no-mar-top"><a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.co.uk/dp/1911742000?linkId=922ecd716b7e71476901c50990a888c7&ref_=as_li_ss_tl&language=en_US&ar_srct=T1&tag=philosophybre-20&linkCode=gt2&creatorsDisableRedirect=true&ar_su=https://a.co/d/01imzxJR&ar_mt=EXACT_MATCH">Amazon</a><a target="_blank" rel="noopener noreferrer sponsored" href="https://uk.bookshop.org/a/17918/9781911742005">Bookshop.org</a><a target="_blank" rel="noopener noreferrer sponsored" href="https://blackwells.pxf.io/xJo21R">Blackwells</a><a target="_blank" rel="noopener noreferrer sponsored" href="https://www.awin1.com/cread.php?awinmid=3787&awinaffid=3020381&ued=https%3A%2F%2Fwww.waterstones.com%2Fbook%2Fthe-philosophy-prescription%2Fjack-maden%2F9781911742005">Waterstones</a><a target="_blank" rel="noopener noreferrer sponsored" href="https://foyles.pxf.io/Pznr5N">Foyles</a><a target="_blank" rel="noopener noreferrer" href="https://www.penguin.co.uk/books/471237/the-philosophy-prescription-by-maden-jack/9781911742005">More (via Penguin)</a></p>
...
export const query = graphql`{
    home: file(relativePath: {eq: "tpp-penguin.jpg"}) {
        ...
        jack: file(relativePath: {eq: "tpp.jpg"}) {
        childImageSharp {
            gatsbyImageData(layout: CONSTRAINED, placeholder: BLURRED)
        }
    }
