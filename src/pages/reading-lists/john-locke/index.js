...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="John Locke" number="5" img={data.title.childImageSharp.gatsbyImageData} alt="The Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Published in 2003, John Dunn’s <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Locke-Short-Introduction-John-Dunn/dp/0192803948?&linkCode=ll1&tag=philosophybre-20&linkId=b5ce970195ef6d082d6d003ab4d84405&language=en_US&ref_=as_li_ss_tl">Locke: A Very Short Introduction</a> is a fantastic place to start for anyone with a budding interest in John Locke’s philosophy.</p>
              <p>Considering the sheer breadth and depth of Locke’s thinking, Dunn does an admirable job in providing an illuminating overview of his most important ideas.</p>
              <p>Dunn also provides helpful background to contextualize Locke’s work, and makes clear why his influence continues to be so enduring. Coming in at an accessible 112 pages, this is a very nice entry point to Locke.</p>
              ...
              <p>Offering the first biography of Locke in over half a century, Woolhouse does a wonderful job in guiding the reader through Locke’s varied life and thought against the historical background of the English Civil War, religious intolerance, and bigotry. Woolhouse not only outlines and contextualizes Locke’s philosophy, but provides facinating insights into debates and arguments he had with other intellectuals of the period.</p>
              <p>With its 560 pages packed full of insight, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Locke-Biography-Roger-Woolhouse/dp/0521748801?&linkCode=ll1&tag=philosophybre-20&linkId=11b6d2726e796b566310285b8fad3fd8&language=en_US&ref_=as_li_ss_tl">Locke: A Biography</a> is a brilliant accompaniment for those seeking a deeper understanding of Locke’s life, thought, and enduring legacy.</p>
              ...
              <p>This particular edition also features Locke’s Letter Concerning Toleration, published in the same year, that aimed to end Christianity's wars of religion and called for the separation of church and state.</p>
