    ...
    <Navigation />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p><span className="big-letter">F</span>yodor Dostoevsky (1821-1881) was a renowned Russian writer whose works greatly influenced literature and existential philosophy. Along with fellow 19th-century Russian author Leo Tolstoy, Dostoevsky is considered to be one of the most prominent literary figures in history, known for his profound exploration of human psychology, morality, and the human condition.</p>

            <p>Dostoevsky stands at the intersection of literature and philosophy, wrestling throughout his work with classic existential themes like suffering, guilt, freedom and responsibility, the existence of God, and the struggle for meaning (see our <Link to="/reading-lists/existentialism/">reading list of existentialism’s best books here</Link>).</p>
            
            <p>His characters are never merely ‘good’ or ‘bad’, but category-defying, flawed, contradictory — in other words, deeply human.</p> 
            
            <p>Philosophers and writers have been hugely inspired by Dostoevsky’s insights into the human condition. Friedrich Nietzsche, for instance, (see our <Link to="/reading-lists/friedrich-nietzsche/">reading list of Nietzsche’s best books here</Link>) wrote:</p>
            ...
            <p>This reading list consists of the best books for getting started with Fyodor Dostoevsky. After reading it, you’ll understand exactly why Dostoevsky is considered one of the greatest and most psychologically insightful writers in history.</p>
              ...
              <p>Immediately before his time in Siberia, Dostoevsky was subject to a mock execution: he and his fellow prisoners were lined up and told they would be shot. The trauma of this experience — lining up, believing it to be the end — infuses Dostoevsky’s prose with a fierce, desperate energy that went on to inform not just this work but all of Dostoevsky’s subsequent writing (for instance, Dostoevsky specifically describes what he believed to be the last moments of his life through his protagonist in <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Idiot-Vintage-Classics-Fyodor-Dostoevsky/dp/0375702245?&linkCode=ll1&tag=philosophybre-20&linkId=8479775d2452333678e48c3ba2e576aa&language=en_US&ref_=as_li_ss_tl">The Idiot</a>).</p>
