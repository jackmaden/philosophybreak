...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Plato" number="6" img={data.title.childImageSharp.gatsbyImageData} alt="The Open Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Given Socrates himself never wrote anything down, scholars have worked hard to distinguish how much of Plato’s work is the neutral recording of Socrates’s views, and how much of it is Plato simply using Socrates as a mouthpiece for his own ideas.</p> 
              <p>Considering Plato continued featuring Socrates as the protagonist of his dialogues even after Socrates’s death, the difficulty scholars have in untangling the two is high — especially in some of Plato’s earlier works.</p>
              ...
              <p>Published in 2003, Julia Annas’s <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/019280216X/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=019280216X&linkId=b93d20476759cd62a49daa83a76504a0">Plato: A Very Short Introduction</a> is a fantastic place to start for anyone with a budding interest in Plato or ancient Greek philosophy generally.</p>
              <p>Annas draws the reader into the world of ancient Athens as presented through Plato’s dialogues, discussing key themes like virtue, the nature of the universe, as well as a dissection of Plato’s attitudes to women, sex, and love.</p>
              <p>Annas also provides helpful tips for how to approach Plato’s dialogues as a reader. Coming in at an accessible 144 pages, this is a very nice entry point to Plato.</p>
              ...
              <p>If you’re seeking to dive a little deeper with your Plato scholarship, look no further than <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/0521436109/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0521436109&linkId=7a5b9c26447c5bd6faa8bbe6fe768b52">The Cambridge Companion to Plato</a>, edited by Richard Kraut.</p>
              <p>Kraut draws together fourteen essays from various Plato scholars discussing Plato’s views on knowledge, reality, mathematics, politics, ethics, love, the arts, and religion.</p>
              <p>With its 576 pages packed full of insight, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/0521436109/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0521436109&linkId=7a5b9c26447c5bd6faa8bbe6fe768b52">The Cambridge Companion to Plato</a> is a brilliant accompaniment for those seeking a deeper understanding of Plato’s thought.</p>
              ...
              <p>Turning from introductions to primary texts, where better to start than with a tome still routinely adored and studied by undergraduate philosophy students to this day?</p>
