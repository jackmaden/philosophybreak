...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="The History of Western Philosophy" number="5" img={data.title.childImageSharp.gatsbyImageData} alt="The Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Kenny combines rich biographical context with academic rigour to create a wonderfully lucid account of philosophy's development, making <a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.com/gp/product/0631201327/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0631201327&linkId=90456aeb8e19235364653210179e838b">A New History of Western Philosophy</a> an essential book to have on the shelf for anyone interested in philosophy.</p>
              ...
              <p>If you're looking for a more manageable read on Western philosophy's history that still covers all the bases in thoughtful fashion, this is the book for you.</p>
              ...
              <p>You might think assembling 63 separate scholars to contribute toward a complete history of Western philosophy would lead to a mess of conflicting styles, interpretations, and opinions. Not so: enter Richard Popkin.</p>
              ...
              <p>A little lighter than other entries on this list, Bryan Magee's <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/019289322X/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=019289322X&linkId=582829b6ab8e2814e7c66f3f6b6526a5">The Great Philosophers: An Introduction to Western Philosophy</a>, published in 1987, is a must for two reasons.</p>
              <p>Firstly, it offers an exciting account of Western philosophy's greatest thinkers.</p>
              <p>Secondly, it does so through interviews with some of the most important philosophers of the late 20th century, granting insight into their thoughts, ideas, and personalities too.</p>
              <p>This approach leads to a thoroughly engaging overview for anyone interested in Western philosophy.</p>
