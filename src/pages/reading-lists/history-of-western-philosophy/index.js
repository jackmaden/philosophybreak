...
export default ({ data, location }) => (
    <>
    <SEO title="History of Western Philosophy – 5 Essential Books to Read" description="A curated reading list of the best and essential books on the history of Western philosophy." pathname={location.pathname} />
    <Layout>
        {/*article title*/}
        <TitleReadingList title="History of Western Philosophy" number="5" img={data.whistorylist.childImageSharp.fluid} alt="Western Philosophy" />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <BookLink title="A Brief History of Western Philosophy" author="Anthony Kenny" link="http://www.amazon.com/gp/product/0631201327/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0631201327&linkId=90456aeb8e19235364653210179e838b" img={data.whistorykennybrief.childImageSharp.fluid} />
