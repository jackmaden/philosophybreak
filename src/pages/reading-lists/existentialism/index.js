    ...
    <Navigation />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Before diving into existentialism’s best books, if you’re interested in quickly learning more about existentialism generally, check out my brief <Link to="/articles/what-is-existentialism-3-core-principles-of-existentialist-philosophy/">introduction to existentialist philosophy</Link>, in which I outline its three core principles, as well as my explainer of the slogan Sartre dubbed the first principle of existentialism, <Link to="/articles/existence-precedes-essence-what-sartre-really-meant/"><i>existence precedes essence</i></Link>, my overview of <Link to="/articles/sartre-waiter-bad-faith-and-the-harms-of-inauthenticity/">Sartre’s famous discussion of the waiter and bad faith</Link>, and my discussion of <Link to="/articles/authentic-love-simone-de-beauvoir-on-what-makes-a-healthy-relationship/">Simone de Beauvoir on authentic love</Link>.</p>
