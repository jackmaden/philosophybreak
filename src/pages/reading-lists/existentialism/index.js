...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Existentialism" number="9" img={data.title.childImageSharp.gatsbyImageData} alt="Book, Pipe and Glasses, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Before diving into existentialism’s best books, if you’re interested in quickly learning more about existentialism generally, check out my brief <Link to="/articles/what-is-existentialism-3-core-principles-of-existentialist-philosophy/">introduction to existentialist philosophy</Link>, in which I outline its three core principles, as well as my explainer of the slogan Sartre dubbed the first principle of existentialism, <Link to="/articles/existence-precedes-essence-what-sartre-really-meant/"><i>existence precedes essence</i></Link>, my outline of <Link to="/articles/heidegger-on-being-authentic-in-an-inauthentic-world/">Heidegger on authenticity</Link>, my overview of <Link to="/articles/sartre-waiter-bad-faith-and-the-harms-of-inauthenticity/">Sartre’s famous discussion of the waiter and bad faith</Link>, my overview of <Link to="/articles/5-existential-problems-all-humans-share/">5 existential problems we all share</Link>, and my discussion of <Link to="/articles/authentic-love-simone-de-beauvoir-on-what-makes-a-healthy-relationship/">Simone de Beauvoir on authentic love</Link>.</p>
              ...
              <p>With brilliant narrative storytelling, Bakewell outlines the intersecting lives and philosophies of key existentialist figures — from Sartre, Beauvoir and Merleau-Ponty, to Husserl, Heidegger, and Camus.</p>
              ...
              <p>Walter Kaufmann was a 20th-century philosopher, poet, and renowned translator of Friedrich Nietzsche (see our <Link to="/reading-lists/friedrich-nietzsche/">reading list on Nietzsche’s best books here</Link>).</p>
              
              <p>In his 1956 <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/0452009308/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0452009308&linkId=a51b3051bf15e3ea4b6735b249f4f307">Existentialism from Dostoevsky to Sartre</a>, Kaufmann assembles extracts from key existentialist influencers and thinkers including Dostoevsky (see <Link to="/reading-lists/fyodor-dostoevsky-best-books/">Dostoevsky’s best books here</Link>), Kierkegaard (see <Link to="/reading-lists/soren-kierkegaard-best-books/">Kierkegaard’s best books here</Link>), Nietzsche, Rilke, Kafka (see <Link to="/reading-lists/franz-kafka-best-books/">Kafka’s best books here</Link>), Ortega, Jaspers, Heidegger, Sartre, Beauvoir (see <Link to="/reading-lists/simone-de-beauvoir-best-books/">Beauvoir’s best books here</Link>), and Camus (see <Link to="/reading-lists/albert-camus/">Camus’s best books here</Link>).</p>
              ...
              <h2>5. Either/Or, by Søren Kierkegaard</h2>
              <BookLink title="Either/Or" author="Søren Kierkegaard" link="https://www.amazon.com/Either-Fragment-Life-Penguin-Classics/dp/0140445773?&linkCode=ll1&tag=philosophybre-20&linkId=8e35d270d5f39307c41b6ac33b979b35&language=en_US&ref_=as_li_ss_tl" img={data.four.childImageSharp.gatsbyImageData} />
              ...
              <p>In his 1843 epic <a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.com/Either-Fragment-Life-Penguin-Classics/dp/0140445773?&linkCode=ll1&tag=philosophybre-20&linkId=8e35d270d5f39307c41b6ac33b979b35&language=en_US&ref_=as_li_ss_tl">Either/Or</a> (which also features in our reading list of <Link to="/reading-lists/soren-kierkegaard-best-books/">Kierkegaard’s best books</Link>), the Danish philosopher <Link to="/articles/kierkegaard-on-finding-the-meaning-of-life/">Søren Kierkegaard discusses the search for a meaningful existence</Link> using the voice of two distinct characters.</p>
              ...
              <p>Kierkegaard invites us to explore subjects like boredom, romance, meaning, and culture from these two seemingly irreconcilable perspectives. In doing so, he writes some utterly heart-wrenching, deeply witty, and memorable prose.</p>
              <p>For anyone interested in the origins of existentialist thinking, <a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.com/Either-Fragment-Life-Penguin-Classics/dp/0140445773?&linkCode=ll1&tag=philosophybre-20&linkId=8e35d270d5f39307c41b6ac33b979b35&language=en_US&ref_=as_li_ss_tl">Either/Or</a> is a fantastic place to start.</p>
