...
export default ({ data, location }) => (
    <>
    <SEO title="Philosophy of Language Reading List – The Top 7 Books to Read" description="A curated reading list of the best and most essential books of and about the philosophy of language, including the writings of Wittgenstein, Kripke, and Chomsky." image={data.title.childImageSharp.fluid.src} pathname={location.pathname} />
    <Layout>
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Philosophy of Language" number="7" img={data.title.childImageSharp.fluid} alt="Philosophy of Language" />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>These difficult, brain-bending questions form the basis of the philosophy of language, a core branch of contemporary philosophical thinking. While philosophers throughout history have always pondered the mysteries of language and meaning, it was in the 20th century that linguistic analysis really became a rigorous and mainstream consideration for philosophers.</p>

            <p>The guiding rationale for these more militant so-called ‘analytic’ philosophers is that many seemingly intractable philosophical problems — such as the core issues within <Link to="/reading-lists/metaphysics/">metaphysics</Link> or <Link to="/reading-lists/epistemology/">epistemology</Link> — are simply instances of the problem not being properly expressed through logic, or of language becoming tied up with itself. And that, as soon as the logic or language has been duly untangled, such ‘problems’ will dissolve away.</p>
