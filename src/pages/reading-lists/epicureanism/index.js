  ...
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Often caricatured as a rather hedonistic, pleasure-obsessed philosophy, Epicureanism (as we outline in our brief <Link to="/articles/epicureanism-defined-philosophy-is-a-form-of-therapy/">Epicureanism explainer</Link>) is actually more about living life free from anxiety and bodily pain, and places a strong emphasis on friendship and community in the search for a meaningful, happy human life.</p>
