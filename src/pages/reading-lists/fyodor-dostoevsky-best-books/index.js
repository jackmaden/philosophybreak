...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Fyodor Dostoevsky" number="6" img={data.title.childImageSharp.gatsbyImageData} alt="Fruit and Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p><span className="big-letter">F</span>yodor Dostoevsky (1821-1881) was a Russian writer whose works greatly influenced literature and <Link to="/articles/what-is-existentialism-3-core-principles-of-existentialist-philosophy/">existentialism</Link>. Along with fellow 19th-century Russian author Leo Tolstoy (see our <Link to="/reading-lists/leo-tolstoy-best-books/">reading list of Tolstoy’s best books here</Link>), Dostoevsky is one of the most prominent literary figures in history, celebrated for his profound exploration of human psychology, morality, and the human condition. (See, for example, this famous <Link to="/articles/fyodor-dostoevsky-and-olaf-stapledon-on-true-security/">Dostoevsky passage on true security</Link>).</p>
