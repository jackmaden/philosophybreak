...
export default ({ data, location }) => (
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="An Introduction to Philosophy" number="5" img={data.title.childImageSharp.fluid} alt="Introduction to Philosophy" />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Okay, we're being a little biased here — but our celebrated introductory philosophy course does get rave reviews, and might be just what you're looking for. <Link to="/lifes-big-questions/">Life's Big Questions (and Philosophy's Best Answers)</Link> distills philosophy's best answers to some of life's most troubling questions, taking you on a whirlwind journey of reflection, understanding, and discovery. Each day over five days, you'll receive beautifully-packaged materials that distill philosophy's best wisdom from the last two millennia, as well as guided reflections and curated further reading. Why does anything exist? Is the world around us ‘real’? What makes us conscious? Do we have free will? How should we approach life? We cover all these questions and more, and deliver the materials direct to your inbox, so you can access them forever from any device. <Link to="/lifes-big-questions/">According to one reviewer</Link>, “this course is excellent for anyone who has an interest in philosophy, but didn't get to study it at university. I personally have read some books on philosophy, and this course helped solidify some ideas and introduced me to others. Equally, if you haven't read any philosophy, this is the place I wish I had started.”</p>
            <div className="article white">
                <Link to="/lifes-big-questions/">
                    <Img fluid={data.lbq.childImageSharp.fluid} alt="Life’s Big Questions (and Philosophy’s Best Answers)" />
                    <div className="article-info">
                        <h2>Life’s Big Questions (and Philosophy’s Best Answers)</h2>
...
export const query = graphql`
    query {
        ...
        lbq: file(relativePath: {eq: "Chapter1-full.png"}) {
            childImageSharp {
                fluid(maxHeight: 230, quality: 90) {
                    ...GatsbyImageSharpFluid_withWebp
                }
            }
        }
