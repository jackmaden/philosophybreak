...
export default ({ data, location }) => (
    <>
    <SEO title="An Introduction to Philosophy – The Top 5 Books to Read" description="A curated reading list of the best and most essential introductions to the fascinating subject of philosophy." image={data.title.childImageSharp.gatsbyImageData.src} pathname={location.pathname} />
    <MailchimpPopUp />
    <Layout>
    <Navigation />
        <ScrollProgressBar />
