...
export default ({ data, location }) => (
    <>
    <SEO title="An Introduction to Philosophy – 4 Essential Books to Read" description="A curated reading list of the best and most essential introductions to the fascinating subject of philosophy." pathname={location.pathname} />
    <Layout>
        <ScrollProgressBar />
        {/*article title*/}
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Remember: the aim of philosophy is not necessarily to give you the answers, but to equip you with the right tools to perform your own investigation — and discover the answers for yourself. By introducing the approaches of philosophy's best minds, the books on this list set you on that path.</p>
