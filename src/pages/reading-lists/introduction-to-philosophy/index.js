...
export default ({ data, location }) => (
    <>
    <SEO title="An Introduction to Philosophy – The Top 4 Books to Read" description="A curated reading list of the best and most essential introductions to the fascinating subject of philosophy." image={data.title.childImageSharp.fluid.src} pathname={location.pathname} />
    <Layout>
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
