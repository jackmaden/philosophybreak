...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Alan Watts" number="5" img={data.title.childImageSharp.gatsbyImageData} alt="The Open Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>If you’re looking a book that offers a general summary of Watts’ views, then his 1966 <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Book-Taboo-Against-Knowing-Who/dp/0679723005?&linkCode=ll1&tag=philosophybre-20&linkId=00163375e1e870fd0257d75b7f6f5648&language=en_US&ref_=as_li_ss_tl">The Book: On the Taboo Against Knowing Who You Are</a> is commonly thought to provide a good all-round starting point.</p>
              <p>Watts compellingly shares his own thoughts, and distills and adapts the Hindu philosophy of Vedanta to investigate what he believes to be the root of human conflict: that we each fundamentally misunderstand who we are.</p>
              <p>Imbued with playful takedowns of the idea that the Self is separate from the Whole, this book offers a fantastic entry point to the general themes of Watts’ work and views.</p>
              ...
              <p>In his highly influential 1957 <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Way-Zen-Alan-W-Watts/dp/0375705104?&linkCode=ll1&tag=philosophybre-20&linkId=0f19fd4624f6eeb8b271577c9a30146f&language=en_US&ref_=as_li_ss_tl">The Way Of Zen</a>, Watts provides his definitive introduction to Zen Buddhism.</p>
              <p>This work played a significant role in introducing the principles and practices of this ancient religion and philosophy to a Western audience, and is still routinely celebrated today as a fantastic introductory text (for more here, see our reading list of the <Link to="/reading-lists/buddhist-philosophy/">best books on Buddhism</Link>).</p>
              <p>Watts splits his work into two sections, ‘Background and History’, and ‘Principles and Practice’, offering readers everything they need to begin understanding the enduring wisdom of Zen Buddhism.</p>
