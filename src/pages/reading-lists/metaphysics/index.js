...
export default ({ data, location }) => (
    <>
    <SEO title="Metaphysics – The Top 10 Books to Read" description="A curated reading list of the best and most essential books of and about metaphysics, including the writings of Aristotle, Spinoza, and Immanuel Kant." image={data.title.childImageSharp.fluid} pathname={location.pathname} />
    <Layout>
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Physicists may very well ask these questions too; but when they do so, they are being metaphysicians. At root, many scientific and philosophical problems — including free will, <Link to="/reading-lists/consciousness">consciousness</Link>, and the mind / body dilemma — are metaphysical in nature.</p>
