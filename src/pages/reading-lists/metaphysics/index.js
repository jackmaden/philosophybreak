  ...
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>But, arguably, when it comes to reality, there are questions that go beyond the scope of physics — and it’s here where metaphysicians reside, restless in their creaking upholstery.</p>
            <p>A quick, dirty, and by no means foolproof way to distinguish metaphysics from physics is as follows: physics concerns the ‘how’ of reality, metaphysics concerns the ‘what’ and the ‘why’.</p> <p>For example, physicists may investigate the charge of a particle. A metaphysician asks what <i>is</i> charge, and what <i>is</i> a particle? A physicist may investigate the origins of the universe and theorize about its fundamental laws; a metaphysician asks <Link to="/articles/why-does-anything-exist/"><i>why</i> the universe exists</Link> — and <i>why</i> its laws obtain the way they do. A physicist uses mathematics to express theory; a metaphysician asks what numbers are. Indeed, ontology — the study of being or what it means for something to exist — has been a key battleground for metaphysicians throughout the ages.</p>
