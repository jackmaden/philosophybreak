    ...
    <Navigation />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Turning from introductions and anthologies to primary metaphysical texts, where better to start than with the book from which the subject derives its name?</p>
