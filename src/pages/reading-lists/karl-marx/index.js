...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Karl Marx" number="6" img={data.title.childImageSharp.gatsbyImageData} alt="The Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Considering the sheer breadth and depth of Marx’s thinking, Singer does an admirable job in providing an illuminating overview of his life and most important ideas – including those on alienation, historical materialism, and his economic theory.</p>
              <p>Singer also provides helpful background to contextualize Marx’s work, and makes clear why his influence continues to be so enduring. Coming in at an accessible 152 pages, this is a very nice entry point to Marx.</p>
              ...
              <p>The more thorough, complex, and detailed blueprint for Marxist thinking, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Capital-Critique-Political-Economy-Classics/dp/0140445684?&linkCode=ll1&tag=philosophybre-20&linkId=fe095c562e5a0e8480dbf00fcd32a9dd&language=en_US&ref_=as_li_ss_tl">Das Kapital</a> is Marx’s 1867 magnum opus.</p>
              <p>Marx builds out a sustained critique of capitalism and private property, and asserts his vision for a system of common ownership of the means of production — a communist society built around the maxim, “from each according to his ability, to each according to his need.”</p>
              <p>One of the most important works of political philosophy in history, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Capital-Critique-Political-Economy-Classics/dp/0140445684?&linkCode=ll1&tag=philosophybre-20&linkId=fe095c562e5a0e8480dbf00fcd32a9dd&language=en_US&ref_=as_li_ss_tl">Das Kapital</a> consists of multiple volumes. This particular edition covers the first volume, and belongs on the bookshelf of any aspiring Marx scholar.</p>
