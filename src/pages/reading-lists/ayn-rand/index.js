...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Ayn Rand" number="5" img={data.title.childImageSharp.gatsbyImageData} alt="Book, Pipe and Glasses, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Anne Conover Heller’s brilliant and important 2009 biography of Ayn Rand outlines Rand’s life and work in detail. Extremely well researched, Heller’s book tells the story all the way from Rand’s childhood in Russia to her successes in America.</p>
              <p>While laying bare some of the more controversial and strange events that punctuated Rand’s life, Heller lets readers make up their own mind and come to their own judgments about Rand’s character and work.</p>
              <p>Essential for contextualizing Rand and the impact she’s had, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Ayn-Rand-World-She-Made/dp/0385513992?&linkCode=ll1&tag=philosophybre-20&linkId=33d48c6104a2d74ff845dc3e4ac78c67&language=en_US&ref_=as_li_ss_tl">Ayn Rand and the World She Made</a> is a fantastic and highly recommended place to start for anyone interested in the polarizing figure of Ayn Rand. Both those who condemn her and those who celebrate her will find value in it.</p>
              ...
              <p>This provocative novel makes the philosophy that underpins it clear: Rand believes individual ego is the fountainhead of progress, and that nothing should be allowed to stand in its way.</p>
              ...
              <p>If you’d prefer to understand Rand’s worldview through her essays rather than her fiction, then <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Virtue-Selfishness-Fiftieth-Anniversary/dp/0451163931?&linkCode=ll1&tag=philosophybre-20&linkId=84f36b080fb968e3acc92ddd6ee63a74&language=en_US&ref_=as_li_ss_tl">The Virtue of Selfishness</a> is a good place to start.</p>
              <p>Published in 1964, this short collection of essays outlines the moral principles of Rand’s Objectivism, defending what you’d imagine from the collection’s title: selfishness. Rand asks why human beings need morality, and argues altruism is incompatible with human nature.</p>
              <p>For a quick route into Rand’s thinking, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Virtue-Selfishness-Fiftieth-Anniversary/dp/0451163931?&linkCode=ll1&tag=philosophybre-20&linkId=84f36b080fb968e3acc92ddd6ee63a74&language=en_US&ref_=as_li_ss_tl">The Virtue of Selfishness</a> is an effective read.</p>
              ...
              <p>While her 1967 <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/dp/0452010306?&linkCode=ll1&tag=philosophybre-20&linkId=daab6c4a03267f82d75bfd4cc4bb3b00&language=en_US&ref_=as_li_ss_tl">Introduction to Objectivist Epistemology</a> focuses more prominently on another important component of her thinking (i.e. her <Link to="/reading-lists/epistemology/">epistemology</Link>), it is Rand’s final collection of essays, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Philosophy-Who-Needs-Ayn-Rand/dp/0451138937?&linkCode=ll1&tag=philosophybre-20&linkId=a74452b0cbf158001db77aa75102a4e1&language=en_US&ref_=as_li_ss_tl">Philosophy: Who Needs It</a>, that offers a broader, more accessible overview of her philosophical ideas.</p>
              <p>Published posthomously in 1982, the essays were Rand’s last word, and cover her provocative thoughts on issues ranging from education and morality to censorship, inflation, and philosophy generally.</p>
              <p>If you want to understand certain strands of contemporary American political thinking and ideology, some of their roots can be found in <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Philosophy-Who-Needs-Ayn-Rand/dp/0451138937?&linkCode=ll1&tag=philosophybre-20&linkId=a74452b0cbf158001db77aa75102a4e1&language=en_US&ref_=as_li_ss_tl">Philosophy: Who Needs It</a>.</p>
