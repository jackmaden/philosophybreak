  ...
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Quentin Skinner’s <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Machiavelli-Very-Short-Introduction-Introductions/dp/0198837577?&linkCode=ll1&tag=philosophybre-20&linkId=0f0480a7af5f1d421121f8ac8580abcd&language=en_US&ref_=as_li_ss_tl">Machiavelli: A Very Short Introduction</a> is a fantastic place to start for anyone with a budding interest in Machiavelli. Widely considered to be the best short introduction to Machiavelli, Skinner does an admirable job in providing an illuminating overview of Machiavelli’s life – which includes meetings with kings, the pope, and the Holy Roman Emperor – as well as his most important ideas. Skinner also provides helpful background to contextualize Machiavelli’s work, and makes clear why his influence continues to be so enduring. Coming in at an accessible 144 pages, this is a very nice entry point to Machiavelli.</p>
