  ...
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Published in 1981, Roger Scruton’s <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Kant-Very-Short-Introduction-Introductions/dp/0192801996?&linkCode=ll1&tag=philosophybre-20&linkId=bca1c097fe563415ea4f8ddc8f580d2c&language=en_US&ref_=as_li_ss_tl">Kant: A Very Short Introduction</a> is a fantastic place to start for anyone with a budding interest in Immanuel Kant’s philosophy. Considering the sheer breadth and depth of Kant’s thinking, Scruton does an admirable job in providing an illuminating overview of his most important ideas. Scruton also provides helpful background to contextualize Kant’s work, and makes clear why his influence continues to be so enduring. Coming in at an accessible 160 pages, this is a very nice entry point to Kant.</p>
