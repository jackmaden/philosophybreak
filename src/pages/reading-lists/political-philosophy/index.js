...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    return (
    <>
    <Seo title="Political Philosophy Reading List – The Top 14 Books to Read" description="A curated reading list of the best and most essential books of and about political philosophy, including the writings of Niccolò Machiavelli, Thomas Hobbes, and Karl Marx." image={imagePath} pathname={location.pathname} />
    <MailchimpPopUp />
    <Layout>
    <Navigation />
        <ScrollProgressBar />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <BookLink title="Das Kapital" author="Karl Marx" link="http://www.amazon.com/gp/product/145388632X/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=145388632X&linkId=e787e2b98d768cc3fb12954260c0e13d" img={data.eight.childImageSharp.gatsbyImageData} />
