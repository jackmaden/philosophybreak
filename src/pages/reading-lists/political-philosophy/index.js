...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Political Philosophy" number="14" img={data.title.childImageSharp.gatsbyImageData} alt="The Open Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              <p><span className="big-letter">W</span>hat does a just society look like? What gives states legitimacy, and what level of authority should sovereign powers wield? What’s the best way to organize people? Is an <i>ideal</i> state possible? (Here’s <Link to="/articles/isaiah-berlin-on-why-the-pursuit-of-the-ideal-is-harmful/">Isaiah Berlin’s argument on why pursuing utopia is in fact dangerous</Link>). What purpose should society serve, if any?  <Link to="/articles/hannah-arendt-on-standing-up-to-the-banality-of-evil/">Where does tyranny or evil come from</Link>, and how can its emergence be stopped? Are we born with inherent human rights? If so, what are they? If not, what rights should be enshrined in law and why? How can we bridge ideological divides? (Here’s <Link to="/articles/john-stuart-mill-and-daniel-dennett-on-how-to-critique-the-other-side/">John Stuart Mill and Daniel Dennett on how to critique ‘the other side’</Link>).</p>

              <p>These are just a few of the questions tackled in political philosophy, a branch of philosophy related to <Link to="/reading-lists/ethics-and-morality/">ethics and morality</Link> but centered more specifically around questions concerning justice, property, authority, liberty, and rights at structural and systemic levels. <Link to="/articles/elizabeth-anderson-on-the-tyranny-of-being-employed/">Contemporary philosopher Elizabeth Anderson argues it should scrutinize what she dubs ‘private government’</Link>, too — i.e. modern employment.</p> 
              ...
              <p>Love him or loathe him, understanding the development of global political philosophy would not be possible without studying Karl Marx. (See my full reading list on <Link to="/reading-lists/karl-marx/">Marx’s best books here</Link>.)</p>
              ...
              <p>Required reading for anyone who believes in the equality of the sexes, the central messages of <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/030727778X/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=030727778X&linkId=9ce86319e788dda05f381207ceabe726">The Second Sex</a> are as important today as they were for the housewives of the forties and fifties. (See my full reading list on <Link to="/reading-lists/simone-de-beauvoir-best-books/">Beauvoir’s best books here</Link>.)</p>
              ...
              <p>Covering the role of propaganda, the use of fear, and the nature of isolation and loneliness as preconditions for totalitarian rule — the insights in Arendt’s tour de force are as piercing and relevant today as ever before, rendering <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/0156701537/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0156701537&linkId=7ac4269bfc9bf734ae4a3b2a105c8292">The Origins of Totalitarianism</a> utterly essential for anyone interested in political philosophy and its real-world application. (See my full reading list on <Link to="/reading-lists/hannah-arendt/">Hannah Arendt’s best books here</Link> and <Link to="/articles/hannah-arendt-5-insights-into-totalitarianism/">Arendt’s 5 insights into totalitarianism here</Link>.)</p>
              ...
              <p>Rawls takes as his starting place the idea of the <Link to="/articles/john-rawls-how-a-veil-of-ignorance-can-help-us-build-a-just-society/">“veil of ignorance”</Link>. Essentially, imagine you had no idea where you’d end up in society. You could be rich or poor, healthy or sick. Now, what rules or laws would you agree to before entering society at this random place?</p>
              ...
              <BookLink title="Anarchy, State, and Utopia" author="Robert Nozick" link="https://www.amazon.com/Anarchy-State-Utopia-Robert-Nozick/dp/0465051006?&linkCode=ll1&tag=philosophybre-20&linkId=66fe85d425f2e933d453fc8bca530c05&language=en_US&ref_=as_li_ss_tl" img={data.thirteen.childImageSharp.gatsbyImageData} />
              <p>Published just three years after Rawls’ <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/gp/product/0674000781/ref=as_li_tl?ie=UTF8&tag=philosophybre-20&camp=1789&creative=9325&linkCode=as2&creativeASIN=0674000781&linkId=fcaf217689eb497cbcb91435aa7fdb23">A Theory of Justice</a>, Robert Nozick lays out a substantially different political vision in his electrifying 1974 <a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.com/Anarchy-State-Utopia-Robert-Nozick/dp/0465051006?&linkCode=ll1&tag=philosophybre-20&linkId=66fe85d425f2e933d453fc8bca530c05&language=en_US&ref_=as_li_ss_tl">Anarchy, State, and Utopia</a>.</p>
              ...
              <p><a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.com/Anarchy-State-Utopia-Robert-Nozick/dp/0465051006?&linkCode=ll1&tag=philosophybre-20&linkId=66fe85d425f2e933d453fc8bca530c05&language=en_US&ref_=as_li_ss_tl">Anarchy, State, and Utopia</a> is a brilliant discussion of some of the most contentious issues in contemporary political theory that anyone interested in political philosophy would benefit from reading.</p>
