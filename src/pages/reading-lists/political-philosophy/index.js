    ...
    <Navigation />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Would a list of the most important works in political philosophy be complete without featuring the creator of one of the most influential political theories of all time? The blueprint for Marxist thinking, <a target="_blank" rel="noopener noreferrer sponsored" href="http://www.amazon.com/Capital-Critique-Political-Economy-Classics/dp/0140445684?&linkCode=ll1&tag=philosophybre-20&linkId=fe095c562e5a0e8480dbf00fcd32a9dd&language=en_US&ref_=as_li_ss_tl">Das Kapital</a> is Karl Marx's 1867 magnum opus, in which he builds out his sustained critique of capitalism and private property, and asserts his vision for a system of common ownership of the means of production — a communist society built around the maxim, “from each according to his ability, to each according to his need.” Love him or loathe him, understanding the development of global political philosophy would not be possible without studying Karl Marx. (See our full reading list on <Link to="/reading-lists/karl-marx/">Marx’s best books here</Link>.)</p>
