...
export default ({ data, location }) => (
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Free Will" number="7" img={data.title.childImageSharp.fluid} alt="Free Will" />
        
        {/*reading list content*/}
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            <p><span className="big-letter">A</span>re we free to do as we please? Or is the freedom of choice we feel in our day-to-day lives a mere illusion? Is every action and circumstance predetermined? Or can our wills transcend the past to actively shape the future? Does determinism, the theory that every physical effect is determined by a physical cause, render our ideas of free will and individual responsibility redundant? Or are our concepts of free will and individual responsibility compatible with a deterministic world?</p> 
            <p>These types of questions form the basis of the philosophical quandary of free will. And the stakes are high: if it turns out we have no freedom in how we act, could we really blame people for bad behavior? Could we hold criminals to account, if they had no option but to act criminally? Would systems of ethics and morality have any justification at all?</p>
