...
export default ({ data, location }) => (
    ...
    <Navigation />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            <p><span className="big-letter">A</span>re we free to do as we please? Or is the freedom of choice we feel in our day-to-day lives a mere illusion? Is every action and circumstance predetermined? Or can our wills transcend the past to actively shape the future? Does determinism, the theory that everything is determined by pre-existing causes, render our ideas of free will and individual responsibility redundant? Or are our concepts of free will and individual responsibility compatible with a deterministic world?</p> 
