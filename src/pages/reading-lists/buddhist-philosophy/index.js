...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Buddhist Philosophy" number="7" img={data.title.childImageSharp.gatsbyImageData} alt="Buddhist Philosophy" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Thich Nhat Hanh was a Buddhist Zen master heralded around the world as a fantastic Buddhist advocate and communicator. His brilliant introduction covers the Four Noble Truths, the Noble Eightfold Path, and much more. At 304 pages, this slightly longer introduction to Buddhism comes highly recommended.</p>
              ...
              <div className="article white">
                ...
                <p>Of course, we’re a little biased, as we produced this one — but if you’re seeking to understand some of life’s most influential ethical frameworks, examine the pros and cons of each, and discover how they might apply to your own life, then you are the exact person for whom this guide was created. <Link to="/how-to-live-a-good-life/">How to Live a Good Life (According to 7 of the World’s Wisest Philosophies)</Link> gets rave reviews, is better value than buying introductory books for all philosophies covered, and might be just what you’re looking for!</p>
