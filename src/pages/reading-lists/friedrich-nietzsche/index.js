    ...
    <Navigation />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <p>Perhaps best known for his proclamation that <Link to="/articles/god-is-dead-nietzsche-famous-statement-explained/">God is dead</Link>, along with his critique of conventional morality and religion, Nietzsche is remembered for his attempt to establish what he called a ‘revaluation of all values’, and is celebrated for his brilliant, provocative aphorisms and prose (like, for instance, his vision of the <Link to="/articles/ubermensch-explained-the-meaning-of-nietzsches-superman/">Übermensch</Link>, or his presentation of <Link to="/articles/eternal-recurrence-what-did-nietzsche-really-mean/">the eternal recurrence</Link>, <Link to="/articles/amor-fati-the-stoics-and-nietzsche-different-takes-on-loving-fate/"><i>amor fati</i></Link> or any of the <Link to="/articles/nietzsche-quotes-97-of-his-cleverest-statements/">97 clever Nietzsche passages and quotations we’ve collated here</Link>).</p>
              ...
              <div className="article white">
                ...
                <p>If you’re looking for a modern, accessible, engaging introduction to Nietzsche’s philosophy with none of the nuance sacrificed, then the 2023 <Link to="/introduction-to-nietzsche/">Introduction to Nietzsche and His 5 Greatest Ideas</Link> is designed to help you learn everything you need to know about the brilliant philosopher in 42 self-paced, myth-busting lessons.</p>
                <p>This concise online guide is instantly accessible from any device, distills Nietzsche’s best and most misunderstood ideas (from God is dead to the Übermensch), and allows you to discuss Nietzsche’s philosophy with other members.</p>
