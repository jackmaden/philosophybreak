        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <div className="article white">
                ...
                <p>This concise online guide is instantly accessible from any device, distills Nietzsche’s best and most misunderstood ideas (from God is dead to the Übermensch), and allows you to discuss Nietzsche and philosophy with other members (join 350+ active members inside).</p>
