        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
              ...
              <div className="article white">
                ...
                <p>If you’re looking for a modern, accessible, engaging introduction to Nietzsche’s philosophy with none of the nuance sacrificed, then the 2025 <Link to="/introduction-to-nietzsche/">Introduction to Nietzsche and His 5 Greatest Ideas</Link> is designed to help you learn everything you need to know about the brilliant philosopher in 42 self-paced, myth-busting lessons.</p>
