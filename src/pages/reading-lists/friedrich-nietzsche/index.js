    ...
    <Navigation />
        ...
        <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <div className="course-promo text-center">
                <h4>Introduction to Nietzsche and His 5 Greatest Ideas: 6-Day Course</h4>
                <p className="small-grey-font">Learn everything you need to know about Friedrich Nietzsche in just six days. This introductory course distills Nietzsche’s best and most misunderstood ideas, from God is dead to the Übermensch.</p>
