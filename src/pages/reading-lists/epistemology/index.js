...
export default ({ data, location }) => (
    <>
    <SEO title="Epistemology – The Top 9 Books to Read" description="A curated reading list of the best and most essential books of and about epistemology, including the writings of Plato, John Locke, and David Hume." image={data.title.childImageSharp.fluid} pathname={location.pathname} />
    <Layout>
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
