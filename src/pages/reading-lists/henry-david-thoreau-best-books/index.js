...
const ReadingList = ({ data, location }) => {
  const imagePath = getSrc(data.title)
    ...
    <Navigation />
        <ScrollProgressBar />
        {/*reading list title*/}
        <TitleReadingList title="Henry David Thoreau" number="5" img={data.title.childImageSharp.gatsbyImageData} alt="The Book, by Juan Gris" />
        ...
        <div id="container">
          ...
          <div id="break-start" className="page-center" style={{marginBottom: 48}}>
            ...
            <p>Let’s dive in!</p>
              ...
              <p>This edition of <a target="_blank" rel="noopener noreferrer sponsored" href="https://www.amazon.com/Journal-Thoreau-1837-1861-Review-Classics/dp/159017321X?&linkCode=ll1&tag=philosophybre-20&linkId=032b02218fd811eedd4c9430f893179e&language=en_US&ref_=as_li_ss_tl">The Journal of Henry David Thoreau</a>, edited by Damion Searls, condenses Thoreau’s original 26,000+ pages of journal entries into a single, 700-page volume.</p>
