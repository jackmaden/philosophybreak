...
const Page = ({ location }) => {
    ...
    return (
    <>
    <Seo title="Philosophies for Living, from Aristotle to Confucius" description="Discover practical wisdom from 7 of the world’s most influential philosophies — including Stoicism, Buddhism, and Existentialism — to help you find meaning, purpose, and live a good life." pathname={location.pathname} />
    <Layout>
    <NavigationSimple/>
        {/*page title*/}
            ...
            <div className="page-center mid-pad">
                <div className="text-center">
                    ...
                    <div className="mid-width">
                        <h4 className="small-mar">You’re keen to understand what the best philosophical wisdom says about how to live a good life, but don’t know where to start</h4>
                        ...
                        <h4 className="small-mar">You’d love to inform your own personal philosophy by discovering, understanding, and comparing the wisest and most influential philosophies for life, but don’t have time to wade through all the books and secondary literature</h4>
                        <svg style={{"width": "24px", "height": "24px"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#36b4ff" d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"></path></svg>
                    ...
                    <div className="mid-width text-center large-pad">
                        <h2>Register Now to Stay Notified and Secure a Launch Discount</h2>
                        <div className="separator"></div>
                        <p className="spectral">Coming soon: find meaning, purpose, and learn how to live a good life with practical wisdom from Aristotle, Epicurus, Stoicism, Confucius, Buddhism, Existentialism, and Effective Altruism.</p> 
        ...
        {/*Chapters*
        <div id="look-inside"  className="small-pad grey-background no-pad-bottom-desktop">
            <div className="page-center">
                ...
                <div className="four-col mobile-center small-pad no-pad-desktop">
                    <div className="small-mar-top">
                        ...
                        <p className="small-grey-font">Crystal clear insight into philosophies like Stoicism, Buddhism, and Existentialism.</p>
                    </div>
                    <div className="small-mar">
                        <h5><span style={{"color": "#36b4ff"}}>➤</span> 7 concise chapters</h5>
                        <p className="small-grey-font">One succinct chapter (30-minute read) on each philosophy, distilling millennia of wisdom.</p>
                    </div>
                    <div className="small-mar-top">
                    ...
                    <div className="small-mar">
                        ...
                        <p className="small-grey-font">Access to the exclusive course community to discuss philosophy with other members.</p>
                    </div>
                </div>
            </div>
