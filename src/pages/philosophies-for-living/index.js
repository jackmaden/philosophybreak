...
const Page = ({ location }) => {
    ...
    return (
    <>
    <Seo title="Philosophies for Living: the Ultimate Guide to Choosing Your Personal Philosophy" description="Discover practical wisdom from 7 of the world’s most influential philosophies — including Stoicism, Buddhism, and Existentialism — to help you find meaning, purpose, and live a good life." pathname={location.pathname} />
    <Layout>
    <NavigationSimple/>
        {/*page title*/}
        <div className="top-title darkradial-background course" id="top">
            <div className="page-center text-center">
                <div className="mid-width small-pad-bottom">
                    ...
                    <h1>Philosophies for Living: the Ultimate Guide to Choosing Your Personal Philosophy</h1>
                    <p className="spectral">Find meaning, purpose, and learn how to live a good life by exploring 7 of the world’s most influential philosophies for living — including Stoicism, Buddhism, and Existentialism. Register your interest now:</p> 
            ...
            <div className="page-center mid-pad">
                <div className="text-center">
                    ...
                    <div className="mid-width text-center large-pad">
                        ...
                        <p className="spectral">Explore and compare practical wisdom from Aristotelianism, Epicureanism, Stoicism, Confucianism, Buddhism, Existentialism, and Effective Altruism. Register your interest now:</p> 
