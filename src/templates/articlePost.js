      ...
      <Layout>
        ...
        <WindowHeightWrapper className="title">
          ...
          <animated.div style={dropIn} className="page-center title-center">
            ...
            <div className="time"><Img style={{display: "inline-block"}} fluid={post.frontmatter.authorPic.childImageSharp.fluid} alt={post.frontmatter.author}/>Written by <a href={post.frontmatter.authorLink} target="_blank" rel="noopener noreferrer" style={{ textDecorationColor: "#8c8c8c" }}>{post.frontmatter.author}</a>&nbsp;&nbsp;|&nbsp;&nbsp;{post.frontmatter.date}</div>
          </animated.div>
